      ...
      <div className={styles.btnContainer}>
        ...
        <div className={styles.termsdiv}>
          ...
          <p className={styles.terms}>
            ...
            <span className={styles.conditions}>Terms of Service</span>
            and <span className={styles.conditions}>Privacy Policy</span>,
            including <span className={styles.conditions}>Cookie Use</span>
          </p>
